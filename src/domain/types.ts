...
export type MealPlanEntryType = Enums<'meal_plan_entry_type'>;
export type MealPlanStatus = Enums<'meal_plan_status'>;
export type MealPlanGenerationMode = Enums<'meal_plan_generation_mode'>;
